...
* *Original project:* https://github.com/nstlaurent/DoomLauncher[nstlaurent/DoomLauncher] — created and maintained by Hobomaster22 (https://github.com/nstlaurent[@nstlaurent]), licensed https://www.gnu.org/licenses/gpl-3.0.html[GPL-3.0-only].
...
* *(Linux fork only)* Featured auto-downloads from GitHub (Beautiful Doom, Project Brutality, Freedoom) and official Romero SIGIL zips; ModDB and other hubs as open-in-browser links.
...
Doom Launcher is licensed under the *GNU General Public License v3.0 only*.
