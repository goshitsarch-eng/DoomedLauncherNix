...
namespace UnitTest.Tests
{
    ...
    public class TestStoreGameLoader
    {
        ...
        public void LoadAllStoreGames_FindsWadsInExpectedPriorityOrder()
        {
            ...
            Assert.IsTrue(iwads.Exists(x => x.Replace('\\', '/').Contains("Resources/TestSteamLibrary1/steamapps/common/TestHereticHexen/hexen.wad")));
            Assert.IsFalse(iwads.Exists(x => x.Replace('\\', '/').Contains("Resources/TestSteamLibrary1/steamapps/common/TestHexen/hexen.wad")));
        }
