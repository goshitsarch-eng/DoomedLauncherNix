...
namespace UnitTest.Tests
{
    ...
    public class TestSpecificFiles
    {
        ...
        public void ZipFileManaged()
        {
            ...
            string[] files = SpecificFilesUtil.GetSupportedFiles(ResourceFolder, gameFile, SupportedExtensions);
        ...
        public void UnmanagedFile()
        {
            ...
            IGameFile gameFile = CreateGameFile(path, managed: false);
            string[] files = SpecificFilesUtil.GetSupportedFiles("Doom", gameFile, SupportedExtensions);
