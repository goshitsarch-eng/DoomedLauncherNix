...
namespace UnitTest.Tests
{
    ...
    public class TestFileHandler
    {
        ...
        public void InsertAndSave_NullGameFileFails()
        {
            ...
            var image = Image.Load("Resources/happy.png");
        ...
        public void DeleteFile_DeletesDatabaseEntry()
        {
            ...
            Assert.IsNotNull(fileDataFromDB);
            Assert.IsTrue(File.Exists(Path.Combine("Screenshots", fileDataFromDB.FileName)));
            ...
            Assert.IsFalse(File.Exists(Path.Combine("Screenshots", fileDataFromDB.FileName)));
        }
        ...
        public void DeleteFile_DoesntDeleteFixedContentOnDisk()
        {
            ...
            // We definitely inserted it
            Assert.IsNotNull(fileDataFromDB);
            Assert.IsTrue(File.Exists(Path.Combine("TileImagesTest", fileDataFromDB.FileName)));
        ...
        public void DeleteFile_DeletesDerivedFilesToo()
        {
            ...
            Assert.IsTrue(File.Exists(Path.Combine("Thumbnails", derivedFileDataFromDB.FileName)));
            ...
            Assert.IsFalse(File.Exists(Path.Combine("Thumbnails", derivedFileDataFromDB.FileName)));
        }
