...
namespace UnitTest.Tests
{
    ...
    public class TestGameFileImageHandler
    {
        ...
        public void UpdateImages_RecreatesThumbnailForExistingTitlepic()
        {
            ...
            gameFileImageHandler.InsertTitlePic(gameFile, Image.Load("Resources/happy.png"));
        ...
        public void UpdateImages_DeletesExistingThumbnailWithNoMainImage()
        {
            ...
            var thumbnail = fileHandler.InsertAndSave(gameFile, FileType.Thumbnail, Image.Load("Resources/happy.png"), "png");
