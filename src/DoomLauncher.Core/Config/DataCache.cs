...
namespace DoomLauncher
{
    public class DataCache
    {
        ...
        public void Init(IDataSourceAdapter adapter)
        {
            ...
            DefaultPalette = Palette.From(PaletteResources.DoomPalette);
            HexenPalette = Palette.From(PaletteResources.HexenPalette);
            HereticPalette = Palette.From(PaletteResources.HereticPalette);

            ColorTheme.Current = AppConfiguration.ColorTheme;
