...
namespace DoomLauncher
{
    public class LauncherPath
    {
        ...
        private static readonly char[] PathSplit = PathExtensions.DirectorySeparators;
        ...
        public static string GetDataDirectory()
        {
            if (IsInstalled())
            {
                if (PlatformPaths.IsLinux || PlatformPaths.IsMac)
                    return PlatformPaths.GetXdgDataHome();
