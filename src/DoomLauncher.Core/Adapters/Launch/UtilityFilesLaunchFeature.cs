...
namespace DoomLauncher.Adapters.Launch
{
    ...
    {
        private readonly List<SpecificFilePath> _pathFiles;

        public UtilityFilesLaunchFeature(List<SpecificFilePath> pathFiles)
        {
            _pathFiles = new List<SpecificFilePath>(pathFiles);
        }
